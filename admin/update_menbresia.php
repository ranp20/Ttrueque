      ...
      <div class="content-wrapper">
            ...
            ?>
                        <div id="content-title-add">
                            ...
                            <a href="manage-menbresia.php" id="button-list-left-header"><i class="fa fa-list"
                                    id="icon-btn-list"></i>Lista de Menbresía</a>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="row m-0">
                                            <div class="col-md-12">
                                                <form action="../php/process_admin_update_menbresia.php" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-file img-prod-div">
                                                            <input type="file" value="<?php echo $cat[0]['image'] ?>"
                                                                name="image" class="custom-file-input" id="imagenes"
                                                                accept="image/*">
                                                            <input type="hidden" value="<?php echo $cat[0]['image'] ?>"
                                                                name="image">
                                                            <label class="custom-file-label" for="imagenes"
                                                                maxlength="300"><?php echo $cat[0]['image'] ?></label>
                                                            <?php
                                ...
                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" maxlength="100"
                                                            value="<?php echo $cat[0]['tipo'] ?>" required name="tipo"
                                                            id="tipo" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="cantidad">Cantidad</label>
                                                        <input type="number" maxlength="100"
                                                            value="<?php echo $cat[0]['cantidad'] ?>" required
                                                            name="cantidad" id="cantidad" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name">Precio </label>
                                                        <input type="text" maxlength="100"
                                                            value="<?php echo $cat[0]['precio_eeuu'] ?>" required
                                                    ...
                                                    <div class="product-content">
                                                        <div class="form-content">
                                                            <div class="product-controls-desc">
                                                                <label for=""
                                                                    class="label-product-desc">Descripción</label>
                                                                <textarea id="ckeditor" name="desc" class="ckeditor"
                                                                    cols="30"
                                                                    rows="10"><?php echo $cat[0]['descripcion'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
