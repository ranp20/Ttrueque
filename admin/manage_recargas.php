                        ...
                        foreach ($dat as $value) {
                          if($value['id'] != 1){
                            ...
                            <tr>
                              ...
                              <td>{$value['precio']}</td>
                              <td>
                                <a href='update_wallet_client.php?id={$value['id']}' class='btn btn-primary btn-sm btn-editItem'>
                              ...
                              <td>
                                <a onclick='return confirmdelete()' href='../php/process_admin_delete_wallet_client.php?id={$value['id']}' class='btn btn-danger btn-sm btn-deleteItem'>
