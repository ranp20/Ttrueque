...
$namecategory = (isset($_REQUEST['namecategory'])&& $_REQUEST['namecategory'] !=NULL) ? $_REQUEST['namecategory'] : '';

if($namecategory == $_POST['namecategory']){
	...
	$count_query = $product->get_count_ProdsByNameCategory($namecategory);
	...
	$products = $product->get_limit_ProdsByNameCategory($namecategory, $offset, $per_page);
...
?>
			...
			if($idstorecli == $idtiendacurrent){
				...
				echo "
					<li class='cont-allprods__menu--item'>
						...
						<a href='#' class='cont-allprods__menu--buy button_add_cart_name_cat'
	...
	<div class="alert alert-warning alert-dismissible fade show" role="alert">
  	<p style="margin-bottom:.5rem;font-size: 1.3rem;"><strong>Aviso!!</strong></p>
