<nav class="nav-main__index navbar navbar-expand-lg navbar-dark justify-content-sm-start fixed-top nav-index-ttrq" id="contain-index-nav-ttrk">
  <div class="nav-main__index__clinks box-wuot-pdd container">
      ...
      <div class="nav-main__index__clinks__cSideLeft collapse navbar-collapse p-3 p-lg-0 mt-5 mt-lg-0 d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-between mobileMenu nav-index-ttrq-collapse"
