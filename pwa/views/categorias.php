...
<body class="body-homepwa" style="padding-bottom: 3rem;padding-top: 1rem;">
    ...
    <div id="page">
        ...
        if(isset($_GET['store'])){
        echo '
            <div class="content-ttrk-official-markets-c mrgtop-57 maxwidth-container" id="container_all_categories_in_store">
            ...
            echo '
                <div class="content-ttrk-official-markets-c mrgtop-57 maxwidth-container">
                <div class="contenido-categorias_ttrk-off-header">
                    <div class="content-title-categorias_ttrk">
