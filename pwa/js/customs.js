...
!function () {
    ...
    var d = function (e, t) {
            ...
            n.media = "all",
            n.rel = "stylesheet",
            t && t.detectingConflicts && t.detectionIgnoreAttr && n.setAttributeNode(
        ...
        c = function (e, t) {
            !function (e, t) {
                ...
                if (
                    t && t.detectingConflicts && t.detectionIgnoreAttr && a.setAttributeNode(document.createAttribute(t.detectionIgnoreAttr)),
                    i
                ) 
                    n = i;
                else {
        ...
        e = function (e, t, n) {
            var i = t && void 0 !== t.autoFetchSvg
                    ? t.autoFetchSvg
                    : void 0,
                o = t && void 0 !== t.async
                    ? t.async
                    : void 0,
                r = t && void 0 !== t.autoA11y
                    ? t.autoA11y
                    : void 0,
                a = document.createElement("script"),
                d = document.scripts[0];
            a.src = e,
            void 0 !== r && a.setAttribute(
                "data-auto-a11y",
                r
                    ? "true"
                    : "false"
            ...
            n && n.detectingConflicts && n.detectionIgnoreAttr && a.setAttributeNode(
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var u,
                ...
                m = {
                    detectingConflicts: f.detectConflictsUntil && new Date <= new Date(
            ...
            "js" === f.method && (
                ...
                "pro" === i.license && (l.autoFetchSvg = !0, l.fetchSvgFrom = i.baseUrl + "/releases/" + (
                    "latest" === i.version
                        ? "latest"
                        : "v".concat(i.version)
                ) + "/svgs"),
            ...
            m.detectingConflicts && (
                ...
                r(function () {
                    ...
                    n && n.detectionIgnoreAttr && e.setAttributeNode(
                        document.createAttribute(n.detectionIgnoreAttr)
                    ),
                    n && n.detectionTimeoutAttr && n.detectionTimeout && e.setAttribute(
