...
function list_store_idtienda() {
  ...
  $.ajax({
    url: "controllers/manager-list-tienda-idtienda.php",
    dataType: "JSON",
    method: "POST",
      ...
      if (v.logo == "") {
        $("#info_cli").append(
          ...
          <div class="img-photo-content-user-v">
            <div id="logo_store" style='background-image: url(../shop/images/icons/default-store.png);background-repeat:no-repeat;background-size: contain;background-position: center;'></div>
          </div>
        ...
        $(".content-upd-logo-store_ttrq").html(`
          <div style="background-image: url(../shop/images/icons/default-store.png);background-repeat:no-repeat;background-size: contain;background-position: center;"></div>
        `);
      } else {
        $("#info_cli").append(
          `
          <div class="img-photo-content-user-v">
              <div id="logo_store" style='background-image: url(../shop/images/store/${v.logo});background-repeat:no-repeat;background-size: contain;background-position: center;'></div>
          </div>
          <div class="name-content-user-v">
            <p>` +
            convertMayus(v.nombre) +
