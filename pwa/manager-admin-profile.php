...
<body class="body-managerpwa mrgtop-57" style="padding-bottom: 3rem;">
                                ...
                                <div class="store-config-controls-img">
                                    ...
                                    <div class="container-upd-logo-store_ttrq">
                                        <div class="content-upd-logo-store_ttrq">
                                            <div
                                                style="background-image: url(../shop/images/store/<?php echo $d[0]['logo']; ?>);background-repeat:no-repeat;background-size: contain;background-position: center;">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="js/actions-pages/manager-update-store.js"></script>
    <script src="js/actions-pages/manager-profile-client.js"></script>
</body>
</html>