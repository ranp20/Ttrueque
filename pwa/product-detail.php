...
<head>
  ...
  <title>Product Detail - App WebView</title>
</head>
<body class="body-product-detailpwa">
  ...
  <div class="container-detalle-producto" id="detailprod_ttrq">
  ...
  <script src="js/actions-pages/list-products-detail.js"></script>
