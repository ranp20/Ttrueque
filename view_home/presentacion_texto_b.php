				...
				<section class="c-infTbs__c__item__cont__itm">
					<div class="c-infTbs__c__item__cont__itm__c c-align-l">
						...
						<div class="c-infTbs__c__item__cont__itm__c__cIcon">
							<img src="<?= $url;?>assets/img/iconos_home/FLAT_handshake.svg" alt="icon-advantaje-1" width="100" height="100" decoding="sync">
						</div>
					</div>
				</section>
				<section class="c-infTbs__c__item__cont__itm">
					<div class="c-infTbs__c__item__cont__itm__c c-align-r container-desc-txt-l">
						...
						<div class="c-infTbs__c__item__cont__itm__c__cIcon">
							<img src="<?= $url;?>assets/img/iconos_home/FLAT_shield.svg" alt="icon-advantaje-2" width="100" height="100" decoding="sync">
						</div>
					</div>
				</section>
				<section class="c-infTbs__c__item__cont__itm">
					<div class="c-infTbs__c__item__cont__itm__c c-align-l">
						...
						<div class="c-infTbs__c__item__cont__itm__c__cIcon">
							<img src="<?= $url;?>assets/img/iconos_home/FLAT_dollar.svg" alt="icon-advantaje-3" width="100" height="100" decoding="sync">
						</div>
					</div>
				</section>
				<section class="c-infTbs__c__item__cont__itm">
					<div class="c-infTbs__c__item__cont__itm__c c-align-r container-desc-txt-l">
						...
						<div class="c-infTbs__c__item__cont__itm__c__cIcon">
							<img src="<?= $url;?>assets/img/iconos_home/FLAT_lock.svg" alt="icon-advantaje-4" width="100" height="100" decoding="sync">
						</div>
					</div>
				</section>
			</div>
			    ...
			    <div class="c-infTbs__c__item__foot__c__cB">
			      <div class="c-infTbs__c__item__foot__c__cB__cL">
			        <div class="c-infTbs__c__item__foot__c__cB__cL__cT">
			          ...
			          <a href="#preguntas-frecuentes-ttrueque" class="ayuda">Ayuda</a>
			        </div>
			      	...
			      	<div class="c-infTbs__c__item__foot__c__cB__cR__cBtns">
				        <a class="c-infTbs__c__item__foot__c__cB__cR__cBtns__link" href="https://play.google.com/store/apps/details?id=app.ttruequeqr.com" target="_blank" >
				        	<div class="c-infTbs__c__item__foot__c__cB__cR__cBtns__link__cIcon">
				        		<img src="<?= $url;?>assets/img/Utilities/ttrueque_negocios_sin_limites.png" alt="icon_ttrueque-app_negocios_sin_limite" width="100" height="100" decoding="sync">
				        	</div>
				        ...
				        <a class="c-infTbs__c__item__foot__c__cB__cR__cBtns__link" href="https://play.google.com/store/apps/details?id=app.ttruequetienda.com" target="_blank" >
				        	<div class="c-infTbs__c__item__foot__c__cB__cR__cBtns__link__cIcon">
				        		<img src="<?= $url;?>assets/img/Utilities/ttrueque_lector_qr.png" alt="icon_ttrueque-app_lector_qr" width="100" height="100" decoding="sync">
				        	</div>
			...
			<section class="c-infTbs__c__item__cont__sect box-redx">
				<div class="c-infTbs__c__item__cont__sect__c contn-info-que-es">
					...
					<div class="c-infTbs__c__item__cont__sect__c__cImgB">
						<img src="<?= $url;?>assets/img/svg/business_shop_ttrq.svg" alt="shoppng_in_ttrueque" width="100" height="100" decoding="sync">
					</div>
				</div>
			</section>
			<div class="c-infTbs__c__item__foot">
		...
		<div class="c-infTbs__c__item content-como-se-usa-ttrq" id="guia-al-comprador-ttrueque">
			<section class="c-infTbs__c__item__cont__sect box-redx">
				<div class="c-infTbs__c__item__cont__sect__c">
					...
					<div class="c-infTbs__c__item__cont__sect__c__cSteps">
						<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont">
							<h1>En la web</h1>
							<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps">
								<ul class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m">
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/web-001.svg" alt="Paso_1_client_web" width="100" height="100" decoding="sync">
										</div>
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/web-002.svg" alt="Paso_2_client_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/web-003.svg" alt="Paso_3_client_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/web-004.svg" alt="Paso_4_client_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
						...
						<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont">
							<h1>En la Aplicación</h1>
							<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps">
								<ul class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m">
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/app_001.svg" alt="Paso_1_client_app" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/app_002.svg" alt="Paso_2_client_app" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/app_003.svg" alt="Paso_3_client_app" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/app_004.svg" alt="Paso_4_client_app" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
						...
						<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont">
							...
							<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps">
								<ul class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m">
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/web-001.svg" alt="Paso_1_sell_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
											<p><span>Paso 1:</span> Ingresar tu usuario y contraseña. Si aún no tienes cuenta regístrate <a href="account" title="Registrarse">aquí.</a></p>
										</div>
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/070-webpage-2.svg" alt="Paso_2_sell_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/029-warranty.svg" alt="Paso_3_sell_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/paypal.svg" alt="Paso_4_sell_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
						...
						<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont">
							...
							<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps">
								<ul class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m">
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/034-hand.svg" alt="Paso_1_client_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/app_004.svg" alt="Paso_2_client_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
									...
									<li class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i">
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cIcon">
											<img src="<?= $url;?>assets/img/iconos_home/014-check-list.svg" alt="Paso_3_client_web" width="100" height="100" decoding="sync">
										</div>
										<div class="c-infTbs__c__item__cont__sect__c__cSteps__cont__stps__m__i__cDesc">
							...
							<ul class="c-infTbs__c__item__cont__sect__c__cQstns__m">
								...
								<li class="c-infTbs__c__item__cont__sect__c__cQstns__m__i">
									...
									<div class="c-infTbs__c__item__cont__sect__c__cQstns__m__i__cDesc">
										...
										<ul>
											<li><p><strong>Paso 1: </strong> Ir a la opción "Administrar mi cuenta".</p></li>
											<li><p><strong>Paso 2: </strong> Ir a la sección "Ordenes y pedidos".</p></li>
											<li><p><strong>Paso 3: </strong> Verificar si el usuario confirmó el pedido enviado/recibido.</p></li>
											<li><p><strong>Paso 4: </strong> Cambiar el estado de entrega según las opciones: <strong>Preparando</strong>(Orden por salir)/<strong>En camino</strong>(Orden enviado o saliente)/<strong>Vendido</strong>(Orden completada).</p></li>
											<li><p><strong>Paso 5: </strong> Ir a la sección "Informe de ventas".</p></li>
											<li><p><strong>Paso 6: </strong> Verificar el monto vendido durante el mes y/o ver el reporte mensual.</p></li>
										</ul>
									</div>
								</li>
								<li class="c-infTbs__c__item__cont__sect__c__cQstns__m__i">
									...
									<div class="c-infTbs__c__item__cont__sect__c__cQstns__m__i__cDesc">
										...
										<ul>
											<li><p><strong>Paso 1: </strong> Registrarse mediante la web.</p></li>
											<li><p><strong>Paso 2: </strong> Inicia Sesión mediante la app.</p></li>
											<li><p><strong>Paso 3: </strong> Solicita tu código QR al administrador y/o Visualízalo desde la app.</p></li>
											<li><p><strong>Paso 4: </strong> Finalmente, pásalo por el lector del vendedor de la tienda.</p></li>
										</ul>
									</div>
								</li>
							</ul>
