		...
		<div class="c-sectMain__cgri">
			...
			<div class="c-sectMain__cgri__cSteps">
				<div class="c-sectMain__cgri__cSteps__itm">
					...
					<img loading="lazy" src="img/Utilities/img_txt3_1.jpg" alt="icon_descriptive_page-three" class="img-fluid" width="100" height="100">
				</div>
				<div class="c-sectMain__cgri__cSteps__itm">
					...
					<img loading="lazy" src="img/Utilities/img_txt3_2.jpg" alt="icon_descriptive_page-three" class="img-fluid" width="100" height="100">
				</div>
				<div class="c-sectMain__cgri__cSteps__itm">
					...
					<img loading="lazy" src="img/Utilities/img_txt3_3.jpg" alt="icon_descriptive_page-three" class="img-fluid" width="100" height="100">
				</div>
			</div>
		</div>
	</div>
