			...
			<section class="c-sectMain__cMobDesk">
				<div class="c-sectMain__cMobDesk__cMob">
					...
					<div class="c-sectMain__cMobDesk__cMob__cSteps">
						<div class="c-sectMain__cMobDesk__cMob__cSteps__i">
							...
							<img loading="lazy" src="img/Utilities/img_txt2_1.jpg" alt="icon_descriptive_page-two-mobile" class="img-fluid" width="100" height="100">
						</div>
						<div class="c-sectMain__cMobDesk__cMob__cSteps__i">
							...
							<img loading="lazy" src="img/Utilities/img_txt2_2.jpg" alt="icon_descriptive_page-two-mobile" class="img-fluid" width="100" height="100">
						</div>
						<div class="c-sectMain__cMobDesk__cMob__cSteps__i">
							...
							<img loading="lazy" src="img/Utilities/img_txt2_3.jpg" alt="icon_descriptive_page-two-mobile" class="img-fluid" width="100" height="100">
						</div>
					</div>
				</div>
				<div class="c-sectMain__cMobDesk__cDesk">
					...
					<div class="c-sectMain__cMobDesk__cDesk__i">
						<ul>
							<li>
								<img loading="lazy" src="img/Utilities/img_txt2_1.jpg" alt="icon_descriptive_page-two-desktop" class="img-fluid" width="100" height="100">
							</li>
							<li>
								<img loading="lazy" src="img/Utilities/img_txt2_2.jpg" alt="icon_descriptive_page-two-desktop" class="img-fluid" width="100" height="100">
							</li>
							<li>
								<img loading="lazy" src="img/Utilities/img_txt2_3.jpg" alt="icon_descriptive_page-two-desktop" class="img-fluid" width="100" height="100">
							</li>
						</ul>
					</div>
				</div>
