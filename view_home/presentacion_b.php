    ...
    <div class="c-bannerH__nav__clinks box-wuot-pdd" id="c--navbarcontainerHome">
      ...
      <div class="c-bannerH__nav__clinks__cSideLeft collapse navbar-collapse p-lg-0 mt-5 mt-lg-0 d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-between mobileMenu tabs-header nav-home-collapse" id="navbarSupportedContent">
        <ul class="c-bannerH__nav__clinks__cSideLeft__m navbar-nav align-self-stretch d-flex justify-content-between cont-tabs-principal-home cont-links-pgs-info">
          <a href="#textoinicioshome" class='c-bannerH__nav__clinks__cSideLeft__m__link'>
            <li class="nav-item dropdown">
              <span>INICIO</span>
            </li>
          </a>
          <a href="#que-es-ttrueque" class='c-bannerH__nav__clinks__cSideLeft__m__link'>
            <li class="nav-item dropdown">
              <span>¿QUÉ ES?</span>
            </li>
          </a>
          <a href="#guia-al-comprador-ttrueque" class='c-bannerH__nav__clinks__cSideLeft__m__link'>
            <li class="nav-item dropdown">
              <span>GUÍA AL COMPRADOR</span>
            </li>
          </a>
          <a href="#guia-al-vendedor-ttrueque" class='c-bannerH__nav__clinks__cSideLeft__m__link'>
            <li class="nav-item dropdown">
              <span>GUÍA AL VENDEDOR</span>
            </li>
          </a>
          <a href="#preguntas-frecuentes-ttrueque" class='c-bannerH__nav__clinks__cSideLeft__m__link'>
            <li class="nav-item dropdown">
          ...
          <?php
            if(isset($_SESSION["user"])){
              echo "
                <a href='./' class='c-bannerH__nav__clinks__cSideLeft__m__link'>
                  <li class='nav-item dropdown'>
              ...
              echo "
                <a href='login' class='c-bannerH__nav__clinks__cSideLeft__m__link'>
                  <li class='nav-item dropdown'>
                    <span>TIENDAS TTRUEQUE</span>
                  </li>
                </a>
