    ...
    <div class="content-dash">
      ...
      <div class="content-top">
        <div class="content-title">
          <h1 class="title-dashboard lang_ttrq" key="">Agrega tu servicio</h1>
        </div>
      </div>
                ...
                <div class="form-content">
                    ...
                    <div class="product-controls">
                        <label for="" class="label-product lang_ttrq">
                          <span key="">Nombre del servicio</span>
                    ...
                    <div class="product-controls">
                        <label for="" class="label-product lang_ttrq">
                          <span key="">Categoría del servicio</span>
                          <span class="span-required-add-products_ttrq">&nbsp;*</span>
                        </label>
                    ...
                    <div class="product-controls">
                        <label for="" class="label-product lang_ttrq">
                          <span key="txt-form-add_product-8">Descripción</span>
                          <span class="span-required-add-products_ttrq">&nbsp;*</span>
                        </label>
                    ...
                    <div class="product-controls-imgs">
                        <div class="content-principal-img_product">
                            <label for="" class="label-product-img lang_ttrq">
                              <span key="txt-form-add_product-7">Imágen principal</span>
                              <span class="span-required-add-products_ttrq">&nbsp;*</span>
                            </label>
