        ...
        <div class="box">
          <div class="content-top">
            <div class="content-title">
              <h1 class="title-dashboard lang_ttrq" key="title-top-add-service-cli-ad_cli">Agrega tu servicio</h1>
            </div>
          </div>
          <div class="content-add-product">
            <form action="" class="form-product" method="POST" autocomplete="false" id="form-product" enctype="multipart/form-data">
                <div class="product-content">
                    <div class="product-head lang_ttrq" key="subtitle-top-add-service-cli-ad_cli">Información básica</div>
                    <div class="form-content">
                        <input type="hidden" name="tienda" id="tienda" value="<?php echo $d[0]["tienda"]; ?>">
                        <div class="product-controls">
                          <label for="" class="label-product">
                            <span class="lang_ttrq" key="txt-form-add_service-1">Nombre del servicio</span>
                        ...
                        <div class="product-controls">
                          <label for="" class="label-product">
                            <span class="lang_ttrq" key="txt-form-add_service-2">Categoría del servicio</span>
                            <span class="span-required-add-products_ttrq">&nbsp;*</span>
                          </label>
                          <select type="text" class="input-product select-onehidden" id="list_categories" name="categoria">
                        ...
                        <div class="product-controls">
                          <label for="" class="label-product">
                            <span class="lang_ttrq" key="txt-form-add_service-9">Atención</span>
                            <span class="span-required-add-products_ttrq">&nbsp;*</span>
                          </label>
                          <select name="pais" class="input-product select-onehidden" id="pais">
                            <option value="0" selected>Selecciona el Local</option>
                        ...
                        <div class="product-controls">
                          <label for="" class="label-product">
                            <span class="lang_ttrq" key="txt-form-add_service-4">País</span>
                            <span class="span-required-add-products_ttrq">&nbsp;*</span>
                          </label>
                          <select name="pais" class="input-product select-onehidden" id="pais">
                        ...
                        <div class="product-controls">
                          <label for="" class="label-product">
                            <span class="lang_ttrq" key="txt-form-add_service-6">Precio</span>
                            <span class="span-required-add-products_ttrq">&nbsp;*</span>
                          </label>
                        ...
                        <div class="product-controls">
                          <label for="" class="label-product">
                            <span class="lang_ttrq" key="txt-form-add_service-8">Descripción</span>
                            <span class="span-required-add-products_ttrq">&nbsp;*</span>
                          </label>
                    ...
                    <div class="product-controls-imgs">
                      <div class="content-principal-img_product">
                        <label for="" class="label-product-img">
                          <span class="lang_ttrq" key="txt-form-add_service-7">Imágen principal</span>
                          <span class="span-required-add-products_ttrq">&nbsp;*</span>
                        </label>
                ...
                <button type="submit" class="btn-add-product add_cli-prods-ttrk lang_ttrq" id="btn-product" key="btn-form-add-service">Agregar</button>
            </form>
          </div>
        </div>
      </main>
