            ...
            <div class="product-content">
              <div class="product-head lang_ttrq" key="subtitle-top-update-products-cli-ad_cli">Información básica</div>
                <div class="form-content">
                  ...
                  <div class="product-controls">
                    <label for="" class="label-product lang_ttrq" key="txt-form-add_product-6">Precio</label>
                  ...
                  <div class="product-controls">
                    <label for="" class="label-product lang_ttrq" key="txt-form-update_product-8">Descripción</label>
