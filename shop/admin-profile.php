        ...
        <div class="content-dash">
            ...
            <div class="container-total_profile-config_ttrq">
                ...
                <div class="content-profile">
                    ...
                    <form action="php/update_user-profile.php" method="POST" ectype="multipart/form-data">
                        ...
                        <div class="profile-content">
                            ...
                            <div class="form-content-profile">
                                <div class="profile-controls">
                                    ...
                                    <input type="text" readonly name="name_cli" class="input-profile" value="<?php echo $d[0]['nombre_cliente'] . " " . $d[0]['apellido_cliente']; ?>">
                                </div>
                                <div class="profile-controls">
                                    <label for="" class="label-profile lang_ttrq" key="txt-form-1-cli-dp-ad_cli-2">Tu correo electrónico</label>
                                    <input type="text" readonly class="input-profile" value="<?php echo $d[0]['email_cliente']; ?>">
                                </div>
                                <!-- <div class="profile-controls">
                        ...
                        <div class="profile-content">
                            ...
                            <div class="form-content-profile">
                                ...
                                <div class="profile-controls">
                                    ...
                                    <input type="text" readonly name="country_cli" class="input-profile" value="<?php echo $d[0]['nombre_pais']; ?>">
                                </div>
                                <div class="profile-controls">
                                    <label for="" class="label-profile lang_ttrq" key="txt-form-2-cli-de-ad_cli-2">Dirección</label>
                                    <input type="text" readonly name="city_cli" class="input-profile" value="<?php echo $d[0]['direccion_cliente']; ?>">
                                </div>

                                <div class="profile-controls">
                                    <label for="" class="label-profile lang_ttrq" key="txt-form-2-cli-de-ad_cli-3">Teléfono</label>
                                    <input type="text" readonly name="telephone_cli" class="input-profile" value="<?php echo $d[0]['telefono']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="profile-controls-submit">
                            <button type="submit" class="btn-submit-profile lang_ttrq" key="btn-updt-cli-form-1-ad_cli">Actualizar</button>
                        </div>
                    </form>
                </div>
                <!--------------->
                ...
                <div class="content-store-config">
                    ...
                    <form action="" method="POST" ectype="multipart/form-data">
                        ...
                        <div class="store-config-content">
                            <div class="store-config-head lang_ttrq" key="subtitle-form-3-cli-ad_cli">Información Básica</div>
                                ...
                                <div class="store-config-controls-img">
                                    ...
                                    <div class="container-upd-logo-store_ttrq">
                                        <div class="content-upd-logo-store_ttrq">
                                            <div style="background-image: url(./images/store/<?php echo $d[0]['logo']; ?>);background-repeat:no-repeat;background-size: contain;background-position: center;"></div>
                                        </div>
                                    </div>
