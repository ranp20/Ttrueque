  ...
  <div class="container-total active">
    ...
    <section class="content-dash">
      ...
      <div class="content-about-to-pay">
        ...
        <h3 class='price_wallet_USD'>
          <span class="price_wallet_USD--prefixSig"></span>
          <span class="price_wallet_USD--amount"></span>
          <span class="price_wallet_USD--prefixLetter"></span>
        </h3>
        <input type="hidden" class="price_wallet">
        <div class="cont-btn-paypal-upd-wallet">
          <!-- /BUTTON FOR PAYPAL-->
        </div>
        <p class="about-text-parr-two"><span class="lang_ttrq" key="title-checkwallet-cli-ad_cli-3">Para la recarga de </span><strong class='cap_carga_wallet'></strong><span class="lang_ttrq" key="title-checkwallet-cli-ad_cli-4"> Bikkers.</span></p>
