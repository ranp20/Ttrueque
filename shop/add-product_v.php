                    ...
                    <div class="product-content">
                        ...
                        <div class="form-content">
                            ...
                            <div class="product-controls">
                                <label for="" class="label-product lang_ttrq" key="txt-form-add_product-1">Nombre del producto</label>
                                <input type="text" name="name" class="input-product" id="name">
                            </div>
                            <!--  CATEGORÍA DEL PRODUCTO -->
                            <div class="product-controls">
                                <label for="" class="label-product lang_ttrq" key="txt-form-add_product-2">Categoría del producto</label>
                                <select type="text" class="input-product select-onehidden" id="list_categories" name="categoria" value="Selecciona la Categoría">
                                </select>
                            </div>
                            <!--  MARCA DEL PRODUCTO -->
                            <div class="product-controls">
                                <label for="" class="label-product lang_ttrq" key="txt-form-add_product-3">Marcas</label>
                                <select type="text" name="marca" class="input-product select-onehidden" id="marca" value="Selecciona una marca">
                                </select>
                            </div>
                            <!--  PAÍS DEL PRODUCTO -->
                            <div class="product-controls">
                                <label for="" class="label-product lang_ttrq" key="txt-form-add_product-4">Pais</label>
                                <select name="pais" class="input-product select-onehidden" id="pais" value="Selecciona una marca">
                        ...
                        <div class="form-content">
                            <div class="product-controls-imgs">
                                <div class="content-principal-img_product"> 
                                    <label for="" class="label-product-img lang_ttrq" key="txt-form-add_product-7">Imágen principal</label>
                                    <div class="add-img-primary">
                                        <input type="file" name="imagen[]" class="input-product-img imgs" id="img" accept="img/*">
                                    </div>
                                </div>
                    ...
                    <div class="product-content">
                        <div class="form-content">
                            <div class="product-controls-desc">
                                <label for="" class="label-product-desc lang_ttrq" key="txt-form-add_product-8">Descripción</label>
